...
public class StudentController extends CommonController<Student, StudentService> {
    ...
    public ResponseEntity<?> optionsHandler() {
    ...
    public ResponseEntity<?> createWithImage(@Valid @ModelAttribute Student student, BindingResult bindingResult,
    ...
    public ResponseEntity<?> updateWithImage(@Valid @ModelAttribute Student student, BindingResult bindingResult,
